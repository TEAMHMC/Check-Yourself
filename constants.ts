...
export const STRINGS = {
  en: {
    ...
    caregiverHmcUnstoppable: 'HMC Unstoppable — Free wellness workshops & community meetups',
    caregiverHmcPodcast: 'Unboxed on Mental Health — Podcast for caregivers & families',
    caregiverHmcReferral: 'HMC Referral Support — (323) 990-4325',
  ...
  es: {
    ...
    caregiverHmcUnstoppable: 'HMC Unstoppable — Talleres de bienestar y encuentros comunitarios gratuitos',
    caregiverHmcPodcast: 'Unboxed on Mental Health — Podcast para cuidadores y familias',
    caregiverHmcReferral: 'Apoyo de Referencia HMC — (323) 990-4325',
