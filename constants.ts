...
export const STRINGS = {
  en: {
    ...
    calmKitSub: 'Guided breathing, audio resets, and meditations to help you settle.',
    calmKitBtn: 'GET STARTED IMMEDIATELY',
    returnDashboard: 'Return to Start',
    contextHeader: 'The Big Picture',
    environmentHeader: 'External Stressors',
    severityMap: {
    ...
    caregiverHmcUnstoppable: 'HMC Unstoppable. Free wellness workshops and community meetups',
    caregiverHmcPodcast: 'Unboxed on Mental Health. A podcast for caregivers and families',
    caregiverHmcReferral: 'HMC Referral Support. Call (323) 990-4325',
  ...
  es: {
    ...
    calmKitSub: 'Respiración guiada, reinicios de audio y meditaciones para ayudarte a calmarte.',
    calmKitBtn: 'EMPEZAR AHORA MISMO',
    returnDashboard: 'Volver al Inicio',
    contextHeader: 'El Panorama General',
    environmentHeader: 'Estresores Externos',
    severityMap: {
    ...
    caregiverIntroOther: 'Para un ser querido, para ver cómo está.',
    ...
    caregiverHmcPodcast: 'Unboxed on Mental Health. Un podcast para cuidadores y familias',
    caregiverHmcReferral: 'Apoyo de Referencia HMC. Llama al (323) 990-4325',
